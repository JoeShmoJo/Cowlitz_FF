...
OUT_DOCX = r"MEMO_CAS_Combined_FlowFrequency_DRAFT.docx"
...
def main():
    ...
    # ============================================================
    h1(doc, "8. Extension to the Columbia River Confluence")
    ...
    para(doc, "The regulated frequency curve developed above applies at "
              ...
              "confluence requires a coincident frequency analysis "
              "combining the regulated Cowlitz flow with Columbia River "
              "stage, supported by regional flood frequency estimates for "
              "the intervening ungaged area. That analysis is in progress "
              "and will be documented in this section, expected to cover "
              "the coincident frequency method and the assumed dependence "
              "between Cowlitz and Columbia flooding; the regional "
              "regression estimates for the ungaged local area below "
              "Castle Rock; the resulting regulated frequency estimates at "
              "the downstream locations required for levee analysis; and "
              "how the Section 5.6 uncertainty is carried through that "
              "combination.")
