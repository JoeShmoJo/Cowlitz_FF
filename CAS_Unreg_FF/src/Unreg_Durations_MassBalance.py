...
# Daily MOS elevation: the daily USGS record. This is a separate,
# cleaner record -- NOT derived from the hourly CWMS-CLEAN telemetry.
# (Hourly CWMS-CLEAN is used only in the holdout workflow, where the
# STOR-COUNT screen + manual overrides gate it day by day; much of the
# post-1974 hourly record is not usable at hourly resolution.)
# Legacy source for reproducing the archived memo-01 results (against
# the frozen dataprep obsData.dss only):
#   //MOS/ELEV-FOREBAY//1DAY/IRVZZAZD_CLEANED/
MOS_ELEV_PATH    = "//MOS/ELEV//1DAY/USGS/"
